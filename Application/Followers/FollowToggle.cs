...
namespace Application.Followers
{
    public class FollowToggle
    {
        ...
        public class Handler : IRequestHandler<Commnad, Result<Unit>>
        {
            ...
            {
                var obsever = await _context.Users.FirstOrDefaultAsync(x =>
                ...
                var following = await _context.UserFollowings.FindAsync(obsever.Id, target.Id);
                if (following == null)
                {
                ...
                return Result<Unit>.Failure("Failled to in followings");
            }
        }
    }
}